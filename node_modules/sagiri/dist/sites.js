...
const Fakku = {
    ...
    backupUrl: (data) => { var _a; return `https://www.fakku.net/hentai/${(_a = data.data.source) === null || _a === void 0 ? void 0 : _a.toLowerCase().replace(" ", "-")}`; },
};
const NHentai = {
    name: "H-Misc (nHentai)",
    index: 18,
    urlMatcher: /https?:\/\/nhentai.net\/g\/\d+/i,
    backupUrl: (data) => { var _a; return `https://nhentai.net/g/${(_a = data.header.thumbnail.match(/nhentai\/(\d+)/)) === null || _a === void 0 ? void 0 : _a[1]}`; },
};
const TwoDMarket = {
    name: "2D-Market",
    index: 19,
...
const Ehentai = {
    ...
    backupUrl: (data) => { var _a; return `https://e-hentai.org/g/${(_a = data.header.thumbnail.match(/e-hentai\/(\d+)/)) === null || _a === void 0 ? void 0 : _a[1]}`; }
};
const ArtStation = {
    name: "FurAffinity",
    index: 39,
